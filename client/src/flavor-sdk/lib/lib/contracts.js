...
import FlavorPodJson from '../contracts/FlavorPod.json';
...
export class Contracts {
  constructor(
    ...
    this.flavorPod = new this.web3.eth.Contract(FlavorPodJson);
  ...
  setProvider(
    ...
    this.flavorPod.setProvider(provider);
    const contracts = [
      { contract: this.flavorPod, json: FlavorPodJson },
    ]
    ...
    this.names = {};
    //this.names[this.usdc.options.address] = "USDC";
  }

  setDefaultAccount(
    account
  ) {
    this.flavorPod.options.from = account;
  }
